...
void PCLVisualizer::saveSetting(QString key, QString value)
{
    //写ini文件，记录当前窗口位置和大小：
    QString wstrFilePath =
        qApp->applicationDirPath() + "/setting.ini"; // .ini放在工程源文件目录下
...
void PCLVisualizer::createActions()
{
    //添加点云
    // addCloudAction =
...
void PCLVisualizer::createMenus()
{}

void PCLVisualizer::createToolBars()
{
    //点云文件工具栏
...
void PCLVisualizer::on_actiongetAllGeo_triggered()
{
